...
class AnalyticsControllerTest < ActionController::TestCase
  ...
  test "should create analytic" do
    assert_difference('Analytic.count') do
      post :create, analytic: { description: @analytic.description, location: @analytic.location, name: @analytic.name }
    end
  ...
  test "should update analytic" do
    patch :update, id: @analytic, analytic: { description: @analytic.description, location: @analytic.location, name: @analytic.name }
    assert_redirected_to analytic_path(assigns(:analytic))
  end
