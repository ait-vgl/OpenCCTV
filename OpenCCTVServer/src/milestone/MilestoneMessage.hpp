...
public:
	 ...
	 */
	static string getConnectMessage(int iRequestid, string &sUsername, string &sPassword, const string &sCameraid, int iWidth, int iHeight, bool bKeepAspectRatio, bool bAllowUpsizing);
	/**
