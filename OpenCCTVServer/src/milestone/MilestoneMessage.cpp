...
namespace milestone
{
string MilestoneMessage::getConnectMessage(int iRequestId, string &sUsername, string &sPassword, const string &sCameraId, int iWidth, int iHeight, bool bKeepAspectRatio, bool bAllowUpsizing)
{
	ptree tree;
